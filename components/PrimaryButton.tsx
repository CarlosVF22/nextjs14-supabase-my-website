...
export default function PrimaryButton() {
    return (
        <button
            ...
            className="transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300 rounded-full w-36 h-8 md:w-48 md:h-10 lg:w-56 lg:h-12 bg-amber-500 hover:bg-amber-300 text-lg md:text-xl lg:text-2xl"
